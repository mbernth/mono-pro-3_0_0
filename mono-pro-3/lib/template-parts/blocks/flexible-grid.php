...
?>
    ...
    <div id="<?php echo esc_attr( $id ); ?>" 
        class="<?php echo esc_attr( $classes ); ?> alignfull <?php if ( get_field( 'top_and_bottom_padding' ) == 1 ) : ?>has-top-bottom-padding<?php endif; ?> <?php if ( $wd_color_text_class ) { ?>has-<?php echo $wd_color_text_class; ?>-color<?php } ?>  <?php if ( $wd_color_class ) { ?>has-<?php echo $wd_color_class; ?>-background-color<?php } ?>">
    <div class="gridcontainer coll<?php the_field( 'number_of_columns' ); ?> <?php if ( get_field( 'use_column_gap' ) == 1 ) { ?>has-column-gap<?php }else{ ?>has-no-column-gap<?php } ?> <?php echo esc_attr( $classes_align ); ?> <?php if ( get_field( 'top_and_bottom_margin' ) == 1 ) { ?>has-top-bottom-margin<?php } ?>">
